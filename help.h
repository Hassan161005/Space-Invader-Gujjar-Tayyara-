...
bool isKeyPressed(int& whichKey)   //whichKey passed as reference.... 
{
	...
	if (key == 1)
	{
		...
		whichKey = 6;   // 6 if space key is pressed
		return true;
	}
	...
	if (key == 1)
	{
		...
		whichKey = 8;   // 8 if R key is pressed
		return true;
	}
	...
	if (key == 1)
	{
		...
		whichKey = 12;   // 12 if S key is pressed
		return true;
	}
	...
	if (key == 1)
	{
		...
		whichKey = 9;   // 9 if N key is pressed
		return true;
	}
	...
	if (key == 1)
	{
		...
		whichKey = 10;   // 10 if H key is pressed
		return true;
	}
	...
	key = GetAsyncKeyState(77);
	if (key == 1)
	{

		whichKey = 13;   // 13 if M key is pressed
		return true;
	}
	return false;
}
